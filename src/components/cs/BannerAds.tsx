...
import { Search, RotateCcw, Download, Plus, Image, Eye, Edit, Trash2, ToggleLeft, ToggleRight } from "lucide-react";
  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        <h1 className="text-xl font-bold text-gray-900">Banner Ad Management</h1>
        <div className="flex gap-2">
          ...
          <button className="h-9 px-4 text-sm bg-blue-600 text-white rounded-md hover:bg-blue-700 flex items-center gap-1.5"><Plus className="w-3.5 h-3.5" />Add Banner</button>
        </div>
      </div>
      <div className="bg-white rounded-lg border border-gray-200 p-4">
        <div className="grid grid-cols-5 gap-3">
          ...
          <div><label className="block text-xs font-medium text-gray-500 mb-1">Position</label><select className="w-full h-9 px-3 text-sm border border-gray-300 rounded-md"><option>All</option><option>Top</option><option>Side</option><option>Bottom</option><option>Popup</option></select></div>
          <div><label className="block text-xs font-medium text-gray-500 mb-1">Status</label><select className="w-full h-9 px-3 text-sm border border-gray-300 rounded-md"><option>All</option><option>Active</option><option>Inactive</option><option>Expired</option></select></div>
      ...
      <div className="app-table-wrap">
        <table className="app-table">
          <thead><tr>
            ...
            <th className="px-3 py-2 text-xs font-medium text-gray-500 text-left">Preview</th>
            <th className="px-3 py-2 text-xs font-medium text-gray-500 text-left">Title</th>
            <th className="px-3 py-2 text-xs font-medium text-gray-500 text-left">Position</th>
            <th className="px-3 py-2 text-xs font-medium text-gray-500 text-left">Link URL</th>
            <th className="px-3 py-2 text-xs font-medium text-gray-500 text-left">Period</th>
            <th className="px-3 py-2 text-xs font-medium text-gray-500 text-left">Clicks</th>
            <th className="px-3 py-2 text-xs font-medium text-gray-500 text-left">Impressions</th>
