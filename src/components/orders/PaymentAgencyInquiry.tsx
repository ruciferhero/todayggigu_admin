...
export default function PaymentAgencyInquiry() {
  const { t } = useLocale();
  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        <h1 className="text-xl font-bold text-gray-900">{t("orders.paymentAgency.inquiryTitle")}</h1>
      ...
      <div className="app-table-wrap">
        <table className="app-table">
          <thead><tr>
            ...
            <th className="px-3 py-2 text-xs font-medium text-gray-500 text-left">{t("orders.common.inquiryNumber")}</th>
            <th className="px-3 py-2 text-xs font-medium text-gray-500 text-left">{t("orders.common.membershipCode")}</th>
            <th className="px-3 py-2 text-xs font-medium text-gray-500 text-left">{t("orders.common.subject")}</th>
