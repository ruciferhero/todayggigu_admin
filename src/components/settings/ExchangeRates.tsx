      ...
      <div className="app-table-wrap">
        <table className="app-table">
          <thead><tr>
            ...
            <th className="px-3 py-2 text-xs font-medium text-gray-500 text-left">Date</th><th className="px-3 py-2 text-xs font-medium text-gray-500 text-left">Currency</th><th className="px-3 py-2 text-xs font-medium text-gray-500 text-left">Buy Rate</th><th className="px-3 py-2 text-xs font-medium text-gray-500 text-left">Sell Rate</th><th className="px-3 py-2 text-xs font-medium text-gray-500 text-left">Applied Rate</th><th className="px-3 py-2 text-xs font-medium text-gray-500 text-left">Margin</th><th className="px-3 py-2 text-xs font-medium text-gray-500 text-left">Status</th>
