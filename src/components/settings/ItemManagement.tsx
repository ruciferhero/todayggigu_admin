      ...
      <div className="bg-white rounded-lg border border-gray-200 overflow-x-auto">
        <table className="w-full text-sm">
          <thead><tr className="bg-gray-50 border-b border-gray-200">
            ...
            <th className="px-3 py-2 text-xs font-medium text-gray-500 text-left">Item Code</th><th className="px-3 py-2 text-xs font-medium text-gray-500 text-left">Item Name (KR)</th><th className="px-3 py-2 text-xs font-medium text-gray-500 text-left">Item Name (EN)</th><th className="px-3 py-2 text-xs font-medium text-gray-500 text-left">Category</th><th className="px-3 py-2 text-xs font-medium text-gray-500 text-left">HS Code</th><th className="px-3 py-2 text-xs font-medium text-gray-500 text-left">Tax Rate</th><th className="px-3 py-2 text-xs font-medium text-gray-500 text-left">Unit</th><th className="px-3 py-2 text-xs font-medium text-gray-500 text-left">Status</th>
