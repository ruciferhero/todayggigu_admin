  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        <h1 className="text-xl font-bold text-gray-900">Rates Management</h1>
      ...
      <div className="bg-white rounded-lg border border-gray-200 overflow-x-auto">
        <table className="w-full text-sm">
          <thead><tr className="bg-gray-50 border-b border-gray-200">
            ...
            <th className="px-3 py-2 text-xs font-medium text-gray-500 text-left">Category</th><th className="px-3 py-2 text-xs font-medium text-gray-500 text-left">Rate Type</th><th className="px-3 py-2 text-xs font-medium text-gray-500 text-left">Basic</th><th className="px-3 py-2 text-xs font-medium text-gray-500 text-left">VIP</th><th className="px-3 py-2 text-xs font-medium text-gray-500 text-left">SVIP</th><th className="px-3 py-2 text-xs font-medium text-gray-500 text-left">Business</th><th className="px-3 py-2 text-xs font-medium text-gray-500 text-left">Applied From</th><th className="px-3 py-2 text-xs font-medium text-gray-500 text-left">Status</th>
