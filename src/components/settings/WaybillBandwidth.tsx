...
export default function WaybillBandwidth() {
  const { t } = useLocale();
  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        <h1 className="text-xl font-bold text-gray-900">Waybill Bandwidth</h1>
      ...
      <div className="bg-white rounded-lg border border-gray-200 overflow-x-auto">
        <table className="w-full text-sm">
          <thead><tr className="bg-gray-50 border-b border-gray-200">
            ...
            <th className="px-3 py-2 text-xs font-medium text-gray-500 text-left">Carrier</th><th className="px-3 py-2 text-xs font-medium text-gray-500 text-left">Service Type</th><th className="px-3 py-2 text-xs font-medium text-gray-500 text-left">Start Number</th><th className="px-3 py-2 text-xs font-medium text-gray-500 text-left">End Number</th><th className="px-3 py-2 text-xs font-medium text-gray-500 text-left">Current</th><th className="px-3 py-2 text-xs font-medium text-gray-500 text-left">Used</th><th className="px-3 py-2 text-xs font-medium text-gray-500 text-left">Remaining</th><th className="px-3 py-2 text-xs font-medium text-gray-500 text-left">Status</th>
