...
import { Search, RotateCcw, Download, Plus, TrendingUp } from "lucide-react";

export default function ProductPriceIncrease() {
  const { t } = useLocale();
  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        <h1 className="text-xl font-bold text-gray-900">Product Price Increase</h1>
        <div className="flex gap-2">
          ...
          <button className="h-9 px-4 text-sm bg-blue-600 text-white rounded-md hover:bg-blue-700 flex items-center gap-1.5"><Plus className="w-3.5 h-3.5" />Add Price Change</button>
        </div>
      </div>
      <div className="bg-white rounded-lg border border-gray-200 p-4">
        <div className="grid grid-cols-4 gap-3">
          <div><label className="block text-xs font-medium text-gray-500 mb-1">Product</label><input type="text" className="w-full h-9 px-3 text-sm border border-gray-300 rounded-md" /></div>
          <div><label className="block text-xs font-medium text-gray-500 mb-1">Status</label><select className="w-full h-9 px-3 text-sm border border-gray-300 rounded-md"><option>All</option><option>Pending</option><option>Applied</option><option>Cancelled</option></select></div>
      ...
      <div className="app-table-wrap">
        <table className="app-table">
          <thead><tr><th className="px-3 py-2 text-xs font-medium text-gray-500 text-left">No</th><th className="px-3 py-2 text-xs font-medium text-gray-500 text-left">Product</th><th className="px-3 py-2 text-xs font-medium text-gray-500 text-left">Category</th><th className="px-3 py-2 text-xs font-medium text-gray-500 text-left">Original Price</th><th className="px-3 py-2 text-xs font-medium text-gray-500 text-left">New Price</th><th className="px-3 py-2 text-xs font-medium text-gray-500 text-left">Increase</th><th className="px-3 py-2 text-xs font-medium text-gray-500 text-left">Effective Date</th><th className="px-3 py-2 text-xs font-medium text-gray-500 text-left">Status</th><th className="px-3 py-2 text-xs font-medium text-gray-500 text-left">Actions</th></tr></thead>
