...
export const menuItems: MenuItem[] = [
  {
    ...
    children: [
      { key: "business-orders-all", labelKey: "submenu.orders", path: "/admin/orders/business" },
      { key: "business-orders-pending", labelKey: "submenu.pendingPayment", path: "/admin/orders/business/pending" },
      { key: "business-orders-nodata", labelKey: "submenu.noData", path: "/admin/orders/business/no-data" },
      { key: "business-orders-inquiry", labelKey: "submenu.orderInquiry", path: "/admin/orders/business/inquiry" },
    ],
  },
  {
    key: "rocket-orders",
    ...
    children: [
      { key: "rocket-orders-all", labelKey: "submenu.orders", path: "/admin/orders/rocket" },
      { key: "rocket-orders-pending", labelKey: "submenu.pendingPayment", path: "/admin/orders/rocket/pending" },
      { key: "rocket-orders-nodata", labelKey: "submenu.noData", path: "/admin/orders/rocket/no-data" },
      { key: "rocket-orders-inquiry", labelKey: "submenu.orderInquiry", path: "/admin/orders/rocket/inquiry" },
    ],
  },
  {
    key: "vvic-orders",
    ...
    children: [
      { key: "vvic-orders-all", labelKey: "submenu.orders", path: "/admin/orders/vvic" },
      { key: "vvic-orders-pending", labelKey: "submenu.pendingPayment", path: "/admin/orders/vvic/pending" },
      { key: "vvic-orders-nodata", labelKey: "submenu.noData", path: "/admin/orders/vvic/no-data" },
      { key: "vvic-orders-inquiry", labelKey: "submenu.orderInquiry", path: "/admin/orders/vvic/inquiry" },
    ],
  },
  {
    key: "payment-agency",
  ...
  },
  {
    ...
    children: [
      { key: "sa-orders", labelKey: "submenu.orders", path: "/admin/orders/shipping-agency" },
      { key: "sa-pending", labelKey: "submenu.pendingPayment", path: "/admin/orders/shipping-agency/pending" },
      { key: "sa-nodata", labelKey: "submenu.noData", path: "/admin/orders/shipping-agency/no-data" },
      { key: "sa-inquiry", labelKey: "submenu.orderInquiry", path: "/admin/orders/shipping-agency/inquiry" },
    ],
  },
  {
    key: "trade-services",
